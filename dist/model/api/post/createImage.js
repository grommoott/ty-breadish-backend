...
async function createImage(id, category, extension) {
    try {
        ...
        const response = await bdClient_1.default.query(`insert into images values (default, ${id}, '${(0, _helpers_1.pgFormat)(category)}', '${(0, _helpers_1.pgFormat)(extension)}') returning *`);
