...
apiRouter.get("/recipies/id/:id", recipes_1.default.get);
apiRouter.get("/recipies/list", recipes_1.default.getList);
apiRouter.post("/recipies/create", recipes_1.default.postCreate);
apiRouter.delete("/recipies/id/:id", recipes_1.default.delete);
apiRouter.put("/recipies", recipes_1.default.put);
apiRouter.get("/recipies/images/id/:id", recipes_1.default.getImages);
apiRouter.post("/recipies/images/create", recipes_1.default.postImages);
apiRouter.delete("/recipies/images/id/:id", recipes_1.default.deleteImages);
apiRouter.put("/recipies/images", recipes_1.default.putImages);
